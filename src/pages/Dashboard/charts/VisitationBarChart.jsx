...
const VisitationBarChart = ({ weeklyHeathAnalytics }) => {
            ...
            >
                ...
                <Legend />
                {
                    locations.length > 0 && locations.map((location, i) => {
                        return <Bar key={i} type="monotone" dataKey={location.name} stroke={colors[i]} fill={colors[i]}/>
                    })
                }
            </BarChart>
        </ResponsiveContainer>
...
export default VisitationBarChart
